...
const correo_1 = __importDefault(require("../correo"));
...
class LoginCtrl {
    getUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db_1.default.db2().exec(sql, [id], function (result) {
                let tempUser = {
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var connection = db_1.default.db2();
            var sql = 'SELECT * FROM usuarios WHERE correo=:correo AND contrasena=:contrasena';
            var obj = req.body;
            console.log(obj);
            if (obj.Correo != 'admin') {
                obj.Contrasena = crypto_1.default.createHash('md5').update(obj.Contrasena).digest('hex');
            }
            console.log(obj);
            yield connection.exec(sql, obj, function (result) {
    ...
    sendEmail(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            let transporter = nodemailer_1.default.createTransport({
                service: "gmail",
                auth: correo_1.default.auth,
            });
            var obj = req.body;
            console.log("llego a send");
            console.log(obj);
            let info = yield transporter.sendMail({
                from: "cascarus2@gmail.com",
                to: obj.Correo,
    ...
    createUsr(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var obj = req.body;
            obj.Contrasena = crypto_1.default.createHash('md5').update(obj.Contrasena).digest("hex");
            yield connection.exec(sql, [obj.Correo], function (result) {
                console.log(result);
                console.log(obj);
                if (result.length < 1) {
                    ...
                    connection.exec(sql, obj, function (result) {
                        ...
                        connection.exec(sql, [obj.Correo], function (result) {
    ...
    verify_email(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db_1.default.db2().exec(sql, [id], function (result) {
                ...
                db_1.default.db2().exec(sql, cart, function (result) {
                    res.json(result);
                });
            });
    ...
    restartPass1(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            var sql = "SELECT * FROM USUARIOS WHERE Correo=:correo";
            var obj = req.body;
            console.log(obj);
            yield db_1.default.db2().exec(sql, [obj.Correo], function (result) {
                console.log(result);
                if (result.length == 1) {
                    let tempUser = {
                        id: result[0].COD_USUARIO,
    ...
    restartPass2(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let obj2 = {
                id: id,
                contrasena: crypto_1.default.createHash('md5').update(obj.contra).digest("hex"),
            };
            yield db_1.default.db2().exec(sql, obj2, function (result) {
    ...
    createCompra(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db_1.default.db2().exec(sql, obj, function (result) {
                ...
                db_1.default.db2().exec(sql, [obj.usr], function (result) {
                    res.json(result);
                });
            });
        });
    ...
    sendVenta(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var obj = req.body;
            console.log(obj);
            yield db_1.default.db2().exec(sql, [obj.COD_PRODUCTO], function (result) {
                var temp = result[0];
                console.log(temp);
                ...
                var final = `</tbody>
                        ...
                        <p>Saludos, de parte del equipo de&nbsp;<strong>GTSales Marketplace</strong></p>`;
                var cuerpo = "<tr><td>" + obj.CANTIDAD + "</td><td>" + obj.PRODUCTO + "</td><td>Q." + obj.PRECIO + "</td><td>Q." + obj.SUB_TOTAL + "</td></tr>";
                let transporter = nodemailer_1.default.createTransport({
                    service: "gmail",
                    auth: correo_1.default.auth,
                });
